...
\title{How heavily polluted is the Earth’s atmosphere?\\ Air Quality Data Analysis\\
\renewcommand{\baselinestretch}{1.7}
\textit{\small{Applied Data Analysis, Department of Computer and Communication Sciences,\\ 
École Polytechnique Fédérale de Lausanne}}}

\author{Anton Soldatenkov \\
  {\tt {\scriptsize{anton.soldatenkov@epfl.ch}}} \\\And
  Sorin Mircea \\
  {\tt {\scriptsize{sorin.mircea@epfl.ch}}} \\\And
  Yaroslav Ilichenko \\
  {\tt {\scriptsize{yaroslav.ilichenko@epfl.ch}}} \\\And
  Irina Kozlova \\
  {\tt {\scriptsize{irina.kozlova@epfl.ch}}}}
